...
export const downloadUsersCSV = async (req: Request, res: Response) => {
  try {
    ...
    const flattenedUsers = users.map((user: { id: any; name: any; username: any; isAdmin: any; createdAt: any; userDetails: { email: any; phone: any; address: any; city: any; state: any; pincode: any; }; }) => ({
      id: user.id,
      name: user.name,
